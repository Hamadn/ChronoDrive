    ...
    <section className="py-14 bg-gray-50">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl">
          <h3 className="text-red-700 text-3xl font-semibold sm:text-4xl">
            Meet our team of Engineers, designers, and product managers.
          </h3>
          <p className="text-black mt-3">
            Behind every successful dealership is a team of passionate
            individuals. Get to know the faces behind CHRONODRIVE, each
            dedicated to providing you with an exceptional experience.
          </p>
        </div>
        <div className="mt-12">
